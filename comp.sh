...
gcc -ansi -Wall -Wextra -Werror -pedantic-errors -c spkmeans_goals.c  -lm -o spkmeans_goals.o
gcc -ansi -Wall -Wextra -Werror -pedantic-errors matrix.o graph.o eigen.o spkmeans.o spkmeans_goals.o -lm -o spkmeans
